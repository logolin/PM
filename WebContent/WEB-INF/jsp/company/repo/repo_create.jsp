				...
				<table class="table table-form"> 
					<tbody>
						...
						<tr>
						  ...
						  <td><input type="text" name="client" id="client" value="" class="form-control">
						</td>
						  <td><div class="help-block">例如：/usr/bin/svn, C:\subversion\svn.exe, /usr/bin/git</div></td>
						</tr>
						<tr>
				        <td></td>
				        <td class="text-center"> <button type="submit" id="submit" class="btn btn-primary" data-loading="稍候...">保存</button><a href="javascript:history.go(-1);" class="btn btn-back ">返回</a></td>
				      </tr>
				    </tbody>
				    </table>
				  </form>
