...
<body>
	<form action="" method ="post" onsubmit="return check()">
		...
		<div class="main-wrap">
			<div class="info">
				...
				<div class="input-group" >
				  <input type="text" class="form-control form-date" name="realStarted" id="realStarted" value="<%=Start%>"/>
		...
		<!--  	按钮 -->
		<div class="btn1"> 
			<button type="submit"  data-loading="稍候..." class="btn-save">开始</button>
...
<script type="text/javascript">
	...
	function checkStarted() {
		...
		if(!reg.test(realStarted)) {
			alert("“开始时间”格式不正确，正确格式如“2016-01-12 12:30:07”!") 
			return false;
		}
	}
	//检查总消耗
