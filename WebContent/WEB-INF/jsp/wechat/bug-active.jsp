...
<% String activeDate=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(Calendar.getInstance().getTime()); %>
...
<body>
	<form action="" method="post" onsubmit="return check()" id="">
		<div class="title">
		...
		<div class="main-wrap">
			<div class="info">
				...
				<input type="hidden" name="assignedDate" value="<%=activeDate%>" /> 
				<input type="hidden" name="lastEditedBy" value="${userAccount}"/>
				<input type="hidden" name="lastEditedDate" value="<%=activeDate%>"/>
			</div>
			
			<div class="info">
				<label>影响版本</label>
				<select class="form-control " id="openedBuild" name="openedBuild" style="width:100%">
			...
			<div class="info">
				<label>备注</label>
				<textarea name="comment" id="comment" class="form-control kindeditor"></textarea>
			</div>
